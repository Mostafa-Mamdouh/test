    ...
    public class AntiXssMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            try
            {
                ...
                if ((context.Request.ContentType!=null &&!context.Request.ContentType.Contains("multipart/form-data")) && CrossSiteScriptingValidation.IsDangerousString(content, out _))
                {
